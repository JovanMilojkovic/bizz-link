                    ...
                    <Row>
                        <Col>
                            ...
                            <p className="lead text-center">
                                Create and share virtual business cards with
                                ease.
                            </p>
                    ...
                    <Row>
                        <Col md={4}>
                            <div className="feature-box">
                                ...
                                <p>
                                    Create a professional profile with your
                        ...
                        <Col md={4}>
                            <div className="feature-box">
                                ...
                                <p>
                                    Choose from a variety of card templates and
                                    personalize them to match your brand.
                                </p>
                            </div>
                        </Col>
                        <Col md={4}>
                            <div className="feature-box">
                                ...
                                <p>
                                    Share your virtual business cards easily and
